function Home() {
  return (
    <div>
      ...
      <p>Hosting the GEOMARE conference in this setting is particularly fitting, not only because the faculty works directly in the thematic areas of the event, but also because its academic community brings together researchers and students who contribute both expertise and enthusiasm. Furthermore, the faculty’s open and interdisciplinary spirit reflects the goals of GEOMARE, providing an accessible and collaborative forum for young researchers in Earth and Marine sciences.</p>
